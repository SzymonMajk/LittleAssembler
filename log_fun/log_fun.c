...
void main( void ) {
	...
	printf("pcs = %d, count = %d\n",a,b);
	printf("Number = %d, As = %ld, ",24,fun(24,0,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
	printf("Number = %d, As = %ld, ",0,fun(0,4,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
  
	printf("\nTests for second parameter == 1\n");
	printf("Number = %d, As = %ld, ",6,fun(6,1,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
	...
	printf("pcs = %d, count = %d\n",a,b);
	printf("Number = %d, As = %ld, ",24,fun(24,1,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
	printf("Number = %d, As = %ld, ",0,fun(0,1,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
  
	printf("\nTests for second parameter == 2\n");
	...
	printf("pcs = %d, count = %d\n",a,b);
	printf("Number = %d, As = %ld, ",24,fun(24,2,&a,&b));
	printf("pcs = %d, count = %d\n",a,b);
